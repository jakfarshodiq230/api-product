...
<head>
    ...
    <title>Pos_kopi API Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-auth-refresh">POST api/auth/refresh</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-auth-user-profile">
                                <a href="#endpoints-GETapi-auth-user-profile">GET api/auth/user-profile</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-sales">GET api/sales</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-top-products">
                                <a href="#endpoints-GETapi-top-products">GET api/top-products</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<div class="bash-example">
    ...
    --data "{
    \"name\": \"vmq\",
    \"email\": \"luettgen.claire@example.net\",
    \"password\": \"-e\\/dl4m{o,+]\\\"OP&gt;@\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>validation.between. Example: <code>vmq</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="luettgen.claire@example.net"
               data-component="body">
    <br>
<p>validation.email validation.max. Example: <code>luettgen.claire@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>validation.min. Example: <code>-e/dl4m{o,+]"OP&gt;@</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-auth-user-profile">GET api/auth/user-profile</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/auth/user-profile" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    ...
    --form "price=12"\
    --form "stock=66"\
    --form "category=robusta"\
    --form "image=@C:\Users\Thinkpad A485\AppData\Local\Temp\php9097.tmp" </code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>robusta</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>arabica</code></li> <li><code>robusta</code></li> <li><code>blend</code></li> <li><code>specialty</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>validation.image validation.max. Example: <code>C:\Users\Thinkpad A485\AppData\Local\Temp\php9097.tmp</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "stock=66"\
    --form "category=blend"\
    --form "image=@C:\Users\Thinkpad A485\AppData\Local\Temp\php90B7.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>validation.image validation.max. Example: <code>C:\Users\Thinkpad A485\AppData\Local\Temp\php90B7.tmp</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-top-products">GET api/top-products</h2>
...
<span id="example-requests-GETapi-top-products">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/top-products" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/top-products"
);
...
<span id="example-responses-GETapi-top-products">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-top-products" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-top-products"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-top-products"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-top-products" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-top-products">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-top-products" data-method="GET"
      data-path="api/top-products"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-top-products', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-top-products"
                    onclick="tryItOut('GETapi-top-products');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-top-products"
                    onclick="cancelTryOut('GETapi-top-products');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-top-products"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/top-products</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-top-products"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-top-products"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
